...
class UserCreateView(FormView):
    ...
    def form_valid(self, form):
        ...
        if self.request.POST['next'] == 'back':
            return render(self.request, 'twitter/create.html', {'form': form})
        elif self.request.POST['next'] == 'confirm':
            return render(self.request, 'twitter/create_confirm.html', {'form': form})
            ...
            # 通常このルートは通らない
            return redirect(reverse_lazy('twitter:home'))
